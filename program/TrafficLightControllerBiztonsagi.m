...
%% beallitjuk a lampakat matrixnak megfeleloen
    for k=1:12 %12 sor
        for i=1:12 %12 lampa
            if(TM(row,i) == X1)
                light{i}.MarkerEdgeColor = 'red';
                light{i}.MarkerFaceColor = 'red';
                light{i}.Marker = 's';
            elseif(TM(row,i) == X2)
                light{i}.MarkerEdgeColor = 'yellow';
                light{i}.MarkerFaceColor = 'yellow';
                light{i}.Marker = 's';
            elseif(TM(row,i) == X3)
                light{i}.MarkerEdgeColor = 'green';
                light{i}.MarkerFaceColor = 'green';
                light{i}.Marker = '^';
                if((i == 1) || (i == 2) || (i == 3))
                    light{i}.Marker = 'v';
                elseif((i == 4) || (i == 5) || (i == 6))
            ...
            elseif(TM(row,i) == X8)
                ...
                light{i}.Marker = '+';
            elseif(TM(row,i) == X9)
                light{i}.MarkerEdgeColor = 'magenta';
                light{i}.MarkerFaceColor = 'magenta';
                light{i}.Marker = 's';
            elseif(TM(row,i) == X10)
                light{i}.MarkerEdgeColor = 'white';
                light{i}.MarkerFaceColor = 'white';
                light{i}.Marker = 's';
            end
        end
        pause(0.01)
