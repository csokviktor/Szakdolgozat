...
hold on
plot(N21,N22,'--k', 'linewidth', 1)
hold on
plot(N31,N32,'--k', 'linewidth', 2)
hold on
plot(N41,N42,'--k', 'linewidth', 1)
hold on
...
hold on
plot(W21,W22,'--k', 'linewidth', 1)
hold on
plot(W31,W32,'--k', 'linewidth', 2)
hold on
plot(W41,W42,'--k', 'linewidth', 1)
hold on
...
hold on
plot(S21,S22,'--k', 'linewidth', 1)
hold on
plot(S31,S32,'--k', 'linewidth', 2)
hold on 
plot(S41,S42,'--k', 'linewidth', 1)
hold on
...
hold on
plot(E21,E22,'--k', 'linewidth', 1)
hold on
plot(E31,E32,'--k', 'linewidth', 2)
hold on
plot(E41,E42,'--k', 'linewidth', 1)
hold on
...
% light{3}.MarkerEdgeColor = 'white';
% light{3}.MarkerFaceColor = 'white';
% light{6}.MarkerEdgeColor = 'white';
% light{6}.MarkerFaceColor = 'white';
% light{9}.MarkerEdgeColor = 'white';
% light{9}.MarkerFaceColor = 'white';
% light{12}.MarkerEdgeColor = 'white';
% light{12}.MarkerFaceColor = 'white';
